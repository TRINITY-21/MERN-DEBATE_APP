...
function UploadChallenge(props){
    ...
    const onSubmit = e => {
        ...
        //     alert('enter all fields');
            ...
            axios.post('/api/leaders-vision/add-leaders-vision', dataToSubmit).then((res) => {
                console.log(res);
    ...
    const onDrop = (files) => {
        ...
        //// upload video
        axios.post('/api/leaders-vision/upload', formData, config).then((res)=> {
            //console.log(res)
            if (res.data.success) {
    ...
    const onDropDoc = (files) => {
        ...
        //// upload video
        axios.post('/api/leaders-vision/upload-doc', formData, config).then((res)=> {
            //console.log(res)
            if (res.data.success) {
                setDoc(res.data.doc);
                // setfileName(res.data.fileName);
    ...
    const onDropPdf = (files) => {
        ...
        //// upload video
        axios.post('/api/leaders-vision/upload-pdf', formData, config).then((res)=> {
            //console.log(res)
            if (res.data.success) {
                setPdf(res.data.pdf);
                // setfileName(res.data.fileName);
...
export default withRouter(UploadChallenge);
